...
public class GameFrame extends JFrame{
	...
	private JLabel ulist; private JList<String> userlist;
	...
	GameFrame(Object c)
	{
		...
		sp1 = new JPanel(); sp2 = new JPanel();
		sp1_2= new JPanel(); sp1_1=new JPanel();
		sp2_1 = new JPanel(); sp2_2 = new JPanel(); sp2_3 = new JPanel();
		sp2_1_1 = new JPanel(); sp2_1_2 = new JPanel();
		sp2_2_1 = new JPanel(); sp2_2_2 = new JPanel();
		...
		sp1.setBounds(0, 0, 800, 700); sp2.setBounds(800, 0, 400, 700);
																			//왼쪽
		sp1.setLayout(new BorderLayout()); sp1.add(sp1_1);
		...
		sp1_1.setLayout(new BorderLayout()); sp1_1.setBackground(Color.white);
		sp1_1.add(sg);
		
		sp2.setLayout(null); sp2.add(sp2_1); sp2.add(sp2_2); sp2.add(sp2_3);	//오른쪽
		sp2_1.setBounds(0, 0, 400, 150);
		sp2_2.setBounds(0, 150, 400, 450);
		sp2_3.setBounds(0, 600, 400, 100);

		sp2_1.setLayout(new BorderLayout());											//유저
		sp2_1.add(sp2_1_1,BorderLayout.NORTH); sp2_1.add(sp2_1_2,BorderLayout.CENTER);
		sp2_1_1.add(ulist);sp2_1_2.add(userlist);
		
		sp2_2.setLayout(new BorderLayout());											//택스트
		sp2_2.add(sp2_2_1,BorderLayout.CENTER); sp2_2.add(sp2_2_2,BorderLayout.SOUTH);
		sp2_2_1.setLayout(new GridLayout());
		sp2_2_1.add(js); sp2_2_2.add(chattext); sp2_2_2.add(sendbutton);
