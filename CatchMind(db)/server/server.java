...
public class server extends Thread implements CodeList{
	ServerSocket ss;
	HashMap<String,UserInfo> UI = new HashMap<String,UserInfo>();
	...
	class UserInfo implements Runnable{
		...
		public void processing(String s)
		{
			...
			{
				case Signin : 
					requestmsg(db.Signin(g[0])+"#"+Signin); break;
				case SignCheck:
					requestmsg(db.Checkid(g[0])+"#"+SignCheck); break;
				case Login : 
				...
				case TokenChange : 
					...
					requestmsg("false"+"#"+TokenChange);
					break;
				case Chat : Room.broadcast(msg); break;
				case Draw : Room.broadcast(msg); break;
				default : Room.broadcast(msg); break;
			}
		}
	}	
	class RoomInfo{
