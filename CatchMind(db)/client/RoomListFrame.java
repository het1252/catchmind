...
public class RoomListFrame extends JFrame{
	...
	RoomListFrame(Object c)
	{
		...
		RoomCreateButton = new JButton("规积己");
		GoRoomButton = new JButton("规涝厘");
		...
		add(MainPanel); MainPanel.add(RoomListPanel); MainPanel.add(ButtonPanel);
